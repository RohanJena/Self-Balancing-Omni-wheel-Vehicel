  ...
  SEQUENCE OF STATES : [alpha_dot; alpha; theta_dot; theta]
        Example:
                ...
                B = [x;   # ...alpha_dot
                     ...
                     x]   # ...theta  
  #}
  De = I_pendulum_theta*I_arm + Mp^2*l^2*Rp^2 + I_arm*Mp*l^2 + I_pendulum_theta*Mp*Rp^2 - l^2*Mp^2*Rp^2;
  A =  [0 0 0 g*l^2*Mp^2*Rp;1 0 0 0;0 0 0 g*l*Mp*(Mp*Rp^2 + I_arm);0 0 1 0]/De; # A should be (double) datatype 
  B =  [0;0;Mp*l^2 + I_pendulum_theta;l*Mp*Rp]/De; # B should be (double) datatype
  ##############################################  
