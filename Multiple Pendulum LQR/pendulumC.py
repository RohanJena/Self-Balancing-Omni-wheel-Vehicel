...
U = 0.00
time = 0.01
k = [ 21.85489   , 1.00000  , 16.90133  ,  4.92226]
...
def sysCall_actuation():
    ...
    motor = sim.getObjectHandle('/Base_C/Motor_C')
    arm = sim.getObjectHandle('/Base_C/Motor_C/Arm_C')
    pendulum = sim.getObjectHandle('/Base_C/Motor_C/Arm_C/Elbow_C/Pendulum_C')
    elbow = sim.getObjectHandle('/Base_C/Motor_C/Arm_C/Elbow_C')
    elbow_init = 0
    motor_init = 0
    elbow_init_vel = 0
    motor_init_vel = 0
    ...
    alpha = (motor_angle - motor_init)/100.0
